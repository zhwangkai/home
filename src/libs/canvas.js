! function() {
    ...
    function draw_canvas() {
        ...
        random_points.forEach(function(r, idx) {
            r.x += r.xa,
                r.y += r.ya,
                r.xa *= r.y > canvas_width || r.x < 0 ? -1 : 1,
    ...
    var the_canvas = document.createElement("canvas"),
        ...
        frame_func = window.requestAnimationFrame || window.webkitReqestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFram || function(func) {
    ...
    the_canvas.style.cssText = "background-color: #000000;position:fixed;top:0;left:0;z-index:" + config.z + ";opacity:" + config.o;
